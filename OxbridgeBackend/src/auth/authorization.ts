...
/**
  * Handles review and validation of the user roles and 
  * permissions. If the request comes from a role that's
  * not permitted to access the request; it'll throw an error.
  */
