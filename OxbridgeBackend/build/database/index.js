...
/**
  * Handles database initialization. The setup of this directory
  * is two-fold. The model directory has the DAOs linked to
  * the mongodb. The repository directory has the service
  * classes.
  */
// Build the connection string
const dbURI = `mongodb://${config_1.db.user}:${encodeURIComponent(config_1.db.password)}@${config_1.db.host}:${config_1.db.port}/${config_1.db.name}?authSource=${config_1.db.auth}`;
const options = {
