...
/**
  * Handles review and validation of the authentication bearer.
  * If the authentication bearer isn't registered and matching
  * a user it'll throw an error and disallow the request.
  */
exports.default = router.use(validator_1.default(schema_1.default.auth, validator_1.ValidationSource.HEADER), asyncHandler_1.default(async (req, res, next) => {
    ...
    try {
        // Asks the JWT helper class for the payload, then verifies
