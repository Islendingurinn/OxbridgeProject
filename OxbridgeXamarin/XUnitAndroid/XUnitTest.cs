...
namespace XUnitAndroid
{
    public class XUnitTest
    {
        ...
        [Fact]
        public void TestServerConnectionAppCrash()
        {
            //Arrange
            String username = "jonas.black@hush.ai";
            ...
            {
                //if this point is reached, the app has actually crashed while trying to login
                crash = true;
            }
        ...
        public void TestPasswordReset()
        {
            ...
            try
            {
                serverClient.ResetPassword(username);
            } catch (Exception e)
            {
